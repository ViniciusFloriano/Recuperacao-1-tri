...
<?php
    ...
    if(isset($_GET['idtabuleiro'])) {
        ...
        $quad = new Tabuleiro('','');
        $lista = $quad->select('*', "idtabuleiro = $idtabuleiro");
    }
    ...
    if($acao == "insert") {
        ...
        try{
            $quad = new Tabuleiro($idtabuleiro, $lado);
            $quad->editar();
            header("location:cadTabuleiro.php");
        } catch(Exception $e) {
        ...
        try{
            $quad = new Tabuleiro($idtabuleiro, '');
            $quad->excluir($idtabuleiro);
            header("location:cadTabuleiro.php");
        } catch(Exception $e) {
            ...
            <table border='1' class="table table-light table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td scope="row"><a href="mostrartab.php?idtabuleiro=<?php echo $linha['idtabuleiro']; ?>&lado=<?php echo $linha['lado'];?>"><img src="img/eye.svg" alt=""></a></td>
