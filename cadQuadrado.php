...
<?php
    ...
    if($acao == "insert") {
        try{
            ...
            $quad->inserir();
            header("location:cadQuadrado.php");
        } catch(Exception $e) {
...
<body>
    ...
    <content>
    <form action="<?php if(isset($_GET['id'])) { echo "cadQuadrado.php?id=$id&acao=editar";} else {echo "cadQuadrado.php?acao=insert";}?>" method="post" id="form" style="padding-left: 0.7px;">
        <h1>Criar um Quadrado</h1><br>
        ...
        <div class="col-auto">
            <div class="input-group">    
                ...
                <input required type="text" name="lado" id="lado" value="<?php if (isset($id)) echo $lista[0]['lado'];?>" class="form-control-sm border border-dark rounded-end">
            </div>
        </div><br>
        <div class="col-auto">
            <div class="input-group">    
            ...
            <table border='1' class="table table-light table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td scope="row"><a href="mostrar.php?id=<?php echo $linha['id']; ?>&lado=<?php echo $linha['lado'];?>&cor=<?php echo str_replace('#', '%23', $linha['cor']);?>&idtabuleiro=<?php echo $linha['idtabuleiro'];?>"><img src="img/eye.svg" alt=""></a></td>
                        ...
                        <td><a onclick="return confirm('Deseja mesmo excluir?')" href="cadQuadrado.php?id=<?php echo $linha['id'];?>&acao=excluir"><img src="img/trash-2.svg" alt=""></a></td>
                    </tr>
                <?php } ?> 
                </tbody>
            </table>
